...
//  SpotifyClone
//
//  Created by peppermint100 on 2023/08/13.
//
...
final class PlayerControlsView: UIView {
    ...
    override func layoutSubviews() {
        ...
        playPauseButton.frame = CGRect(x: (width-buttonSize)/2,
                                       y: volumeSlider.bottom+30, width: buttonSize, height: buttonSize)
        backButton.frame = CGRect(x: playPauseButton.left-80-buttonSize,
                                  y: playPauseButton.top, width: buttonSize, height: buttonSize)
