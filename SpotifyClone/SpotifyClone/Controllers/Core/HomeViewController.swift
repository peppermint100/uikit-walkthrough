...
enum BrowseSectionType {
    case newReleases(viewModels: [NewReleasesViewModel]) // 1
    case featuredPlaylists(viewModels: [NewReleasesViewModel]) // 2
    case recommendedTracks(viewModels: [NewReleasesViewModel]) // 3
}
...
class HomeViewController: UIViewController {
    ...
    private func configureModels(newAlbums: [Album], playlists: [Playlist], tracks: [AudioTrack]) {
        sections.append(.newReleases(viewModels: newAlbums.compactMap({
            return NewReleasesViewModel(name: $0.name,
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    static func createSectionLayout(section: Int) -> NSCollectionLayoutSection {
        ...
        case 0:
            ...
            // verticalGroup in horizontalGroup
